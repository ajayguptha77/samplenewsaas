...
import { createContentBankDetails } from '../../graphql/mutations';
...
const AddContentBank = () => {
    ...
    const handleSubmit = async (event: any) => {
        ...
        const getContent: any = await API.graphql(
          graphqlOperation(createContentBankDetails, { input: getDetails })
        );
        if(getContent){
