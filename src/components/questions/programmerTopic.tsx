...
function ProgrammerTopic(props: any) { 
    ...
    // useEffect(() => {
    //   // Set the selected value when props.editValue changes
    //   if (props.editValue && DepartmentName.length > 0) {
    //     let selectedValue:any;
    //     if (typeof props.editValue === 'string') {
    //       selectedValue = props.editValue.progTopic;
    //     } else {
    //       selectedValue = props.editValue.progTopic;
    //     }
    ...
    //     }
    //   }
    // }, [props.editValue, DepartmentName]);
