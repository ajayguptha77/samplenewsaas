...
import { updateContentBankDetails, updateQuestionBankDetails } from '../../graphql/mutations';
import { useLocation, useNavigate } from 'react-router-dom';
import { getContentBankDetails, getQuestionBankDetails, listUsers } from '../../graphql/queries';
...
const UpdateQuestionBank = () => {
    ...
    useEffect(() => {
        async function provInfo() {
            try {
                const getCourseByID = await API.graphql(graphqlOperation(getQuestionBankDetails, {id: location.state.id})) as any;
                setFormData(getCourseByID?.data?.getQuestionBankDetails)
